...
urlpatterns = patterns('',
    ...
    url(r'^all-online/$', 'streams.main.views.all_online'),
    url(r'^search/$', 'streams.main.views.search'),
    url(r'^search/(?P<query>[\w\d\-_ ]+)/$', 'streams.main.views.search'),
    url(r'^search/ajax/(?P<query>[\w\d\-_ ]+)/$', 'streams.main.views.search_ajax'),
    url(r'^(?P<stream_id>\d+)/$', 'streams.main.views.detail'),
    url(r'^homepage/(?P<stream_id>\d+)/$', 'streams.main.views.homepage_stream_numbers'),
